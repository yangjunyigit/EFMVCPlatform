...
{
    public partial class MainRibbonForm1 : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IDockManagerHolder, IBarManagerHolder, ISupportViewChanged, IXafDocumentsHostWindow, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings
    {
        ...
        public MainRibbonForm1()
        {
            ...
            statusMessagesHelper = new StatusMessagesHelper(ribbonControl.StatusBar.ItemLinks);
            OnUITypeChanged();
        }
